...
WORKDIR /go/src/github.com/lasthyphen/archiveus
...
COPY --from=builder /go/src/github.com/lasthyphen/archiveus/docker/config.json /opt/config.json
COPY --from=builder /go/src/github.com/lasthyphen/archiveus/services/db/migrations /opt/migrations
